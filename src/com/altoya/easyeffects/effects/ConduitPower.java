...
public class ConduitPower implements CommandExecutor {
    @Override
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        if (command.getName().equalsIgnoreCase("ConduitPower")) {
            if (sender instanceof Player) {
                String effect = "conduit power";
                String effectType = "CONDUIT_POWER";
