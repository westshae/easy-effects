...
public class HeroOfTheVillage implements CommandExecutor {
    @Override
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        if (command.getName().equalsIgnoreCase("HeroOfTheVillage")) {
            if (sender instanceof Player) {
                String effect = "hero of the village";
                String effectType = "HERO_OF_THE_VILLAGE";
