...
public class SlowFalling implements CommandExecutor {
    @Override
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        if (command.getName().equalsIgnoreCase("SlowFalling")) {
            if (sender instanceof Player) {
                String effect = "slow falling";
                String effectType = "SLOW_FALLING";
