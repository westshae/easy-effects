...
public class Resistance implements CommandExecutor {
    @Override
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        if (command.getName().equalsIgnoreCase("Resistance")) {
            if (sender instanceof Player) {
                String effect = "resistance";
                String effectType = "DAMAGE_RESISTANCE";
