...
public class MiningFatigue implements CommandExecutor {
    @Override
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        if (command.getName().equalsIgnoreCase("MiningFatigue")) {
            if (sender instanceof Player) {
                String effect = "mining fatigue";
                String effectType = "SLOW_DIGGING";
